const config: any = {
  backend: {
    ...
    'MEDIC': 'https://b1.medic.telemedicina.com/api/v1',
    'MEDIC-B2C': 'https://b1.medicconsultasonline.telemedicina.com/api/v1',
    'MEDLINE': 'https://b1.medline.telemedicina.com/api/v1',
    'CEMIG': 'https://b1cemig.telemedicina.com/api/v1',
    'UA': 'https://b1.uacl.telemedicina.com/api/v1',
  ...
  frontend: {
    ...
    'MEDIC': 'https://medic.telemedicina.com/',
    'MEDIC-B2C': 'https://medicconsultasonline.telemedicina.com/',
    'MEDLINE': 'https://medline.telemedicina.com/',
    'CEMIG': 'https://conexaosaude.axismed.com.br/',
    'UA': 'https://uacl.tc.telemedicina.com/',
